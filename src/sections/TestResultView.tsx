        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-3">
               <Badge variant="outline" className="bg-primary/10 text-primary-foreground border-primary/20 px-3 py-1 rounded-lg">
      ...
      <main className="max-w-4xl mx-auto px-4 py-6 space-y-8 pb-24">
        {showSummary && (
          <div className="p-4 sm:p-6 bg-primary/10 border border-primary/20 rounded-2xl sm:rounded-3xl flex items-center gap-4 sm:gap-6 animate-in fade-in slide-in-from-top-4 duration-700">
            ...
            <div>
              ...
              <p className="text-xs sm:text-muted-foreground font-medium">
        ...
        <section className="relative group">
          ...
          <Card className="relative bg-card/40 backdrop-blur-xl border-border/10 rounded-[1.5rem] sm:rounded-[2rem] overflow-hidden">
            <CardContent className="p-6 sm:p-8 flex flex-col items-center">
              <div className="text-[8px] sm:text-[10px] uppercase tracking-[0.3em] font-black text-muted-foreground mb-4 sm:mb-6 bg-primary/5 px-4 py-1.5 rounded-full border border-primary/5">
                Marks Obtained
              </div>
        ...
        <section className="grid grid-cols-3 gap-2 sm:gap-4">
          <Card className="bg-card/40 backdrop-blur-lg border-border/5 rounded-xl sm:rounded-2xl p-3 sm:p-4 flex flex-col items-center text-center group hover:bg-primary/5 transition-colors">
            ...
            <div className="text-[8px] sm:text-[10px] text-muted-foreground font-bold uppercase tracking-widest leading-tight">Attempted</div>
          </Card>
          <Card className="bg-card/40 backdrop-blur-lg border-border/5 rounded-xl sm:rounded-2xl p-3 sm:p-4 flex flex-col items-center text-center group hover:bg-primary/5 transition-colors">
            ...
            <div className="text-[8px] sm:text-[10px] text-muted-foreground font-bold uppercase tracking-widest leading-tight">Accuracy</div>
          </Card>
          <Card className="bg-card/40 backdrop-blur-lg border-border/5 rounded-xl sm:rounded-2xl p-3 sm:p-4 flex flex-col items-center text-center group hover:bg-primary/5 transition-colors">
            ...
            <div className="text-[8px] sm:text-[10px] text-muted-foreground font-bold uppercase tracking-widest leading-tight">Time</div>
          </Card>
        </section>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {displayStrongAreas && displayStrongAreas.length > 0 ? (
                        displayStrongAreas.map((area: any, index: number) => (
                          <Badge key={index} className="bg-primary/10 hover:bg-primary/20 text-primary-foreground border-primary/20 px-4 py-1.5 rounded-xl transition-colors">
                  ...
                  mistakeEntries.map((mistake, index) => (
                    ...
                    >
                      <div className="flex items-center gap-4 relative z-10">
                        <div className={`w-10 h-10 rounded-xl flex items-center justify-center transition-colors ${selectedReviewEntry === index ? 'bg-primary text-white' : 'bg-primary/10 text-primary-foreground'
                          }`}>
                    ...
                    <div className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-500">
                      ...
                      <div className="flex flex-wrap gap-4 pt-4">
                        ...
                        <Button variant="outline" className="rounded-2xl bg-primary/10 border border-primary/20 text-primary font-black uppercase tracking-widest text-xs px-8 h-14 hover:bg-primary/20 transition-colors">
                          <Sparkles className="w-4 h-4 mr-3 text-primary-foreground" />
                          Explain with AI
                        </Button>
                      </div>
                    </div>
