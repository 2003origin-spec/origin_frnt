...
const TIER_THRESHOLDS = [
  ...
  { tier: 'Advanced', min: 1000, next: 1800, icon: Zap, color: 'text-indigo-400', bg: 'bg-indigo-400/10', border: 'border-indigo-400/30', glow: 'shadow-indigo-500/20' },
  { tier: 'Expert', min: 1800, next: 3000, icon: Zap, color: 'text-purple-400', bg: 'bg-purple-400/10', border: 'border-purple-400/30', glow: 'shadow-purple-500/20' },
  { tier: 'Master', min: 3000, next: 5000, icon: Trophy, color: 'text-pink-400', bg: 'bg-pink-400/10', border: 'border-pink-400/30', glow: 'shadow-pink-500/20' },
  { tier: 'Grandmaster', min: 5000, next: 8000, icon: Trophy, color: 'text-amber-400', bg: 'bg-amber-400/10', border: 'border-amber-400/30', glow: 'shadow-amber-500/20' },
  { tier: 'Legend', min: 8000, next: Infinity, icon: Crown, color: 'text-rose-500', bg: 'bg-rose-500/10', border: 'border-rose-500/30', glow: 'shadow-rose-500/20' },
];
