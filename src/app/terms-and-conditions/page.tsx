              ...
              <section id="statutory-notice" className="scroll-mt-36">
                ...
                <div className="text-muted-foreground leading-relaxed space-y-4 font-medium">
                  ...
                  <p className="bg-primary/5 border border-primary/20 p-5 rounded-2xl text-sm font-semibold leading-relaxed">
                    ...
                    <strong>SUPERGOAT TECHNOLOGIES PRIVATE LIMITED</strong>, a company incorporated under the laws of
                    India, with its registered office at Ramnagar road no 1, Agartala, Tripura, India (hereinafter
                    referred to as &lsquo;Platform Owner&rsquo;, &lsquo;we&rsquo;, &lsquo;us&rsquo;, &lsquo;our&rsquo;).
                  </p>
                  <p>
